    ...
    <header className="bg-green-500 text-white py-4 px-6 shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-6 relative">
          ...
          {/* Exibe "Pagamentos" apenas para Shopowners */}
          {authState.user?.role === "shopowner" && (
          ...
          {/* Exibe "Vendedores" apenas para Shopowners */}
          {authState.user?.role === "shopowner" && (
            <div className="relative">
              <button
      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-green-600">
          <ul className="flex flex-col space-y-4 p-4">
            {/* Exibe "Pagamentos" e "Vendedores" apenas para Shopowners */}
            {authState.user?.role === "shopowner" && (
              <>
                <li>
                  <a
